...
# VIDEO PATH
# -------------------------
video_path = r"C:\personal inside\projects\SmartTraffic\vehicle_counting\test(2).mp4"
...
while cap.isOpened():
    ...
    cv2.imshow("Traffic Density Analysis - Test 2", frame)
...
plt.title("Traffic Density Percentage Over Time - Test Video 2")
plt.xlabel("Frame Number")
plt.ylabel("Density Percentage (%)")

plt.grid(True)

plt.savefig("traffic_density_graph_test2.png")

plt.show()

print("Traffic density graph saved as traffic_density_graph_test2.png")