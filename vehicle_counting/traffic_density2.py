...
while cap.isOpened():
    ...
    cv2.putText(frame, f"Density: {density}",
                (20, 90), cv2.FONT_HERSHEY_SIMPLEX, 1, color, 3)

    cv2.putText(frame, f"Density %: {density_percentage:.1f}",
                (20, 140), cv2.FONT_HERSHEY_SIMPLEX, 1, color, 2)
